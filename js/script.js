...
addEventListener("DOMContentLoaded", () => {
    ...
    function createModals(i, item) {
        const modal = document.createElement('div');
        modal.setAttribute('id', `modal${i + 1}`);
        ...
        modal.innerHTML = `
                            <div class="modal-content">
                                ...
                                <div class="modal-param">
                                    ...
                                    <div class="modal-descr">${pets[i].description}</div>
                                    <ul class="modal-list">
                                        <li>Age: <span>${pets[i].age}</span></li>
                                        <li>Inoculations: <span>${pets[i].inoculations}</span></li>
